...
import 'package:finmind/screens/app_login_page.dart';
import 'package:finmind/screens/app_home_page.dart';
import 'package:finmind/util/constants.dart';
import 'package:flutter/material.dart';
import 'package:logger/logger.dart';

class AppSplashPage extends StatefulWidget {
  const AppSplashPage({super.key, this.title = Constants.SPLASH_PAGE_TITLE});
  final String title;
  @override
