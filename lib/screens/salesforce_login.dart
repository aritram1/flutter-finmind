          ...
          navigationDelegate: (NavigationRequest request) async {
            ...
            if (request.url.startsWith(widget.redirectUri)) {
              ...
              if (code != null) {
                ...
                if (tokenResponse.statusCode == Constants.STATUS_CODE_OK) { // Status Code = 200 OK
                  ...
                  if (parsedResponse['access_token'] != null || parsedResponse['instance_url'] != null) {
                    ...
                    await SecureFileManager.setExpiryTimeOfToken(
                      DateTime.now().add(const Duration(minutes: Constants.TOKEN_TIMEOUT_MINUTES)).toString()
                    );
                  } 
                  else {
